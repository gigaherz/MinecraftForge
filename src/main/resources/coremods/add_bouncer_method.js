...
function initializeCoreMod() {
    return {
        "compose_bouncer": addBouncer("net.minecraft.util.math.vector.TransformationMatrix", "compose", "func_227985_a_", true, "(Lnet/minecraft/util/math/vector/TransformationMatrix;)Lnet/minecraft/util/math/vector/TransformationMatrix;"),
        "inverse_bouncer": addBouncer("net.minecraft.util.math.vector.TransformationMatrix", "inverse", "func_227987_b_", false, "()Lnet/minecraft/util/math/vector/TransformationMatrix;"),
